...
const Products = () => {
  ...
  useEffect(() => {
    const loadTestimonies = () => {
      try {
        const storedTestimonials = localStorage.getItem('testimonialItem');
        if (storedTestimonials) {
          ...
          setTestimonials([]); // Default to empty array
        }
      } catch (error) {
        console.error('Error parsing testimonials from localStorage:', error);
        setTestimonials([]); // Handle corrupted data
      }
    };
  ...
  const handleLike = (index) => {
    ...
    localStorage.setItem('testimonialItem', JSON.stringify(newTestimonials));
  };
  ...
  const handleAddTestimonial = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        localStorage.setItem('testimonialItem', JSON.stringify(updatedTestimonials));
